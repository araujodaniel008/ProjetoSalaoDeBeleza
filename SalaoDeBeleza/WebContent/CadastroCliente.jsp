<%@page import="SalaoDeBeleza.cliente.Cliente"%>
...
<body>
	...
	<div class="aaaaform-row">
			...
			<div>
				<label>Situação</label> <select id="situacao" class="form-control">
